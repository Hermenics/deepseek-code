...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: 'goal.maxContinuations', label: 'Default goal turns', description: 'Maximum auto-continuation turns for /goal. Default 10. A goal also pauses after 2 turns in a row without tool calls or file changes. Override per-goal with --turns.', kind: 'number' },
