...
| **Amazon Bedrock** | IAM via `~/.aws/credentials` ou env vars STS | `AWS_REGION`, `AWS_PROFILE` |
...
| Modelo | Endpoint | Inference Profile |
|---|---|---|
| DeepSeek R1 | InvokeModel (non-streaming) | `us.deepseek.r1-v1:0` |
